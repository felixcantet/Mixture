Shader "Unlit/TexturePainterBrushWIP"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float maskSquare(float3 position, float3 center, float radius, float hardness)
            {
                ...
                float mZ = distance(center.z, position.z);
            ...
            {   
                ...
                //float f = maskSquare(float3(uvScreen, 0), float3(uvPaint, 0), _Radius, _Hardness);
                //float f = maskCircle(float3(uvScreen, 0), float3(uvPaint, 0), _Radius, _Hardness);
